      ...
      <div className={classes.blurBackground}>
        <div className={classes.welcomeTextContainer}>
          ...
          <p className={classes.averageText}>
            Discover and savor the rich essence of Zimbabwean culture through
            our premium selection of raw, traditional foods. Experience the
            tastes that have been cherished for generations.{' '}
          </p>
        </div>
